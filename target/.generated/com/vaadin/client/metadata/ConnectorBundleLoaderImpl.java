...
public class ConnectorBundleLoaderImpl extends com.vaadin.client.metadata.ConnectorBundleLoader {
  public void init() {
    addAsyncBlockLoader(new AsyncBundleLoader("__eager", new String[] {"com.vaadin.ui.PopupView","com.vaadin.ui.TwinColSelect","com.vaadin.ui.ComboBox","com.vaadin.ui.FormLayout","com.vaadin.ui.VerticalLayout","com.vaadin.ui.Button","com.vaadin.ui.TextField","com.vaadin.ui.Upload","com.vaadin.ui.UI","com.vaadin.ui.Panel","com.vaadin.ui.VerticalSplitPanel","com.vaadin.ui.GridLayout","com.vaadin.ui.CheckBox","com.vaadin.ui.PasswordField","com.vaadin.ui.AbstractJavaScriptComponent","com.vaadin.server.BrowserWindowOpener","com.vaadin.ui.CustomField","com.vaadin.ui.Window","com.vaadin.ui.InlineDateField","com.vaadin.ui.Image","com.vaadin.ui.AbsoluteLayout","com.vaadin.ui.Embedded","com.vaadin.ui.ListSelect","com.vaadin.server.FileDownloader","com.vaadin.ui.Label","com.vaadin.ui.Video","com.vaadin.ui.Form","com.vaadin.ui.BrowserFrame","com.vaadin.ui.Tree","com.vaadin.ui.ProgressIndicator","com.vaadin.ui.Table","com.vaadin.ui.TreeTable","com.vaadin.ui.CustomLayout","com.vaadin.ui.Flash","com.vaadin.ui.Slider","com.vaadin.ui.HorizontalSplitPanel","com.vaadin.ui.Accordion","com.vaadin.ui.DragAndDropWrapper","com.vaadin.ui.Audio","com.vaadin.ui.TabSheet","com.vaadin.ui.OptionGroup","com.vaadin.ui.Link","com.vaadin.ui.TextArea","com.vaadin.ui.NativeButton","com.vaadin.ui.DateField","com.vaadin.server.AbstractJavaScriptExtension","com.vaadin.ui.JavaScript","com.vaadin.ui.MenuBar","com.vaadin.ui.NativeSelect","com.vaadin.ui.CssLayout","com.vaadin.ui.HorizontalLayout","com.vaadin.ui.CustomComponent","com.vaadin.ui.ProgressBar",}) {
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load2() {
            ...
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.class, new String[] {"id", "caption", "styles", "resources", "primaryStyleName", "registeredEventListeners", "childData", "readOnly", "rows", "errorMessage", "height", "columns", "marginsBitmask", "immediate", "enabled", "spacing", "width", "description", });
            store.setProperties(com.vaadin.shared.ui.customlayout.CustomLayoutState.class, new String[] {"primaryStyleName", "enabled", "childLocations", "width", "templateContents", "height", "caption", "templateName", "resources", "id", "registeredEventListeners", "immediate", "description", "readOnly", "errorMessage", "styles", });
            store.setProperties(com.vaadin.shared.AbstractFieldState.class, new String[] {"resources", "id", "readOnly", "propertyReadOnly", "description", "styles", "errorMessage", "modified", "width", "required", "registeredEventListeners", "immediate", "caption", "tabIndex", "enabled", "primaryStyleName", "height", "hideErrors", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.ChildComponentData.class, new String[] {"alignment", "column2", "column1", "row1", "row2", });
            store.setProperties(com.vaadin.shared.ui.flash.FlashState.class, new String[] {"primaryStyleName", "id", "codetype", "height", "codebase", "archive", "standby", "registeredEventListeners", "readOnly", "errorMessage", "caption", "enabled", "immediate", "width", "embedParams", "styles", "resources", "classId", "description", "alternateText", });
            store.setProperties(com.vaadin.shared.ui.datefield.InlineDateFieldState.class, new String[] {"propertyReadOnly", "immediate", "enabled", "height", "description", "required", "registeredEventListeners", "id", "primaryStyleName", "hideErrors", "resources", "width", "modified", "rangeStart", "tabIndex", "readOnly", "styles", "errorMessage", "caption", "rangeEnd", });
            store.setProperties(com.vaadin.shared.ui.BrowserWindowOpenerState.class, new String[] {"width", "uriFragment", "primaryStyleName", "enabled", "immediate", "resources", "target", "parameters", "description", "caption", "id", "errorMessage", "features", "readOnly", "registeredEventListeners", "height", "styles", });
            store.setProperties(com.vaadin.shared.ui.twincolselect.TwinColSelectState.class, new String[] {"primaryStyleName", "height", "description", "styles", "propertyReadOnly", "hideErrors", "width", "immediate", "caption", "readOnly", "resources", "errorMessage", "tabIndex", "id", "registeredEventListeners", "modified", "enabled", "required", });
            store.setProperties(com.vaadin.shared.ui.table.TableState.class, new String[] {"registeredEventListeners", "tabIndex", "primaryStyleName", "resources", "propertyReadOnly", "readOnly", "id", "height", "caption", "styles", "immediate", "description", "errorMessage", "modified", "hideErrors", "width", "enabled", "required", });
            store.setProperties(com.vaadin.shared.ui.datefield.PopupDateFieldState.class, new String[] {"rangeEnd", "textFieldEnabled", "required", "primaryStyleName", "descriptionForAssistiveDevices", "resources", "rangeStart", "hideErrors", "modified", "caption", "readOnly", "width", "description", "height", "enabled", "tabIndex", "propertyReadOnly", "styles", "immediate", "registeredEventListeners", "errorMessage", "id", });
            store.setProperties(com.vaadin.shared.ui.menubar.MenuBarState.class, new String[] {"readOnly", "resources", "enabled", "errorMessage", "primaryStyleName", "styles", "registeredEventListeners", "height", "tabIndex", "immediate", "caption", "width", "description", "id", });
            store.setProperties(com.vaadin.shared.ui.button.ButtonState.class, new String[] {"registeredEventListeners", "immediate", "readOnly", "disableOnClick", "errorMessage", "description", "styles", "enabled", "resources", "primaryStyleName", "clickShortcutKeyCode", "tabIndex", "width", "caption", "iconAltText", "height", "id", "htmlContentAllowed", });
            store.setProperties(com.vaadin.shared.MouseEventDetails.class, new String[] {"clientX", "clientY", "relativeX", "ctrlKey", "relativeY", "shiftKey", "altKey", "button", "type", "metaKey", });
            ...
            store.setProperties(com.vaadin.shared.ui.orderedlayout.AbstractOrderedLayoutState.class, new String[] {"description", "styles", "caption", "childData", "primaryStyleName", "resources", "id", "errorMessage", "marginsBitmask", "spacing", "enabled", "readOnly", "width", "registeredEventListeners", "height", "immediate", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.HorizontalLayoutState.class, new String[] {"resources", "caption", "marginsBitmask", "styles", "id", "description", "readOnly", "errorMessage", "height", "immediate", "enabled", "spacing", "primaryStyleName", "childData", "registeredEventListeners", "width", });
            store.setProperties(com.vaadin.shared.ui.panel.PanelState.class, new String[] {"id", "height", "styles", "resources", "width", "registeredEventListeners", "tabIndex", "scrollLeft", "primaryStyleName", "description", "immediate", "scrollTop", "readOnly", "errorMessage", "caption", "enabled", });
            store.setProperties(java.util.HashMap.class, new String[] {});
            store.setProperties(com.vaadin.shared.ui.optiongroup.OptionGroupState.class, new String[] {"primaryStyleName", "resources", "errorMessage", "id", "propertyReadOnly", "styles", "enabled", "description", "height", "width", "tabIndex", "immediate", "registeredEventListeners", "caption", "required", "hideErrors", "modified", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.window.WindowState.class, new String[] {"height", "draggable", "resizable", "caption", "scrollLeft", "primaryStyleName", "immediate", "windowMode", "resizeLazy", "modal", "width", "centered", "styles", "resources", "tabIndex", "positionY", "positionX", "registeredEventListeners", "enabled", "errorMessage", "readOnly", "id", "description", "scrollTop", });
            store.setProperties(com.vaadin.shared.ui.progressindicator.ProgressIndicatorState.class, new String[] {"width", "styles", "primaryStyleName", "id", "errorMessage", "required", "description", "propertyReadOnly", "modified", "caption", "pollingInterval", "indeterminate", "immediate", "tabIndex", "registeredEventListeners", "readOnly", "enabled", "resources", "state", "hideErrors", "height", });
            store.setProperties(com.vaadin.shared.ui.combobox.ComboBoxState.class, new String[] {"enabled", "primaryStyleName", "immediate", "hideErrors", "tabIndex", "required", "caption", "errorMessage", "propertyReadOnly", "height", "styles", "registeredEventListeners", "width", "id", "modified", "description", "readOnly", "resources", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.LocaleData.class, new String[] {"twelveHourClock", "shortDayNames", "monthNames", "name", "dateFormat", "dayNames", "shortMonthNames", "am", "pm", "hourMinuteDelimiter", "firstDayOfWeek", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.VerticalLayoutState.class, new String[] {"errorMessage", "enabled", "primaryStyleName", "registeredEventListeners", "childData", "immediate", "caption", "readOnly", "resources", "width", "styles", "id", "marginsBitmask", "spacing", "height", "description", });
            store.setProperties(com.vaadin.shared.ui.slider.SliderState.class, new String[] {"value", "maxValue", "enabled", "primaryStyleName", "styles", "minValue", "tabIndex", "id", "resolution", "errorMessage", "caption", "orientation", "description", "registeredEventListeners", "propertyReadOnly", "required", "modified", "immediate", "resources", "hideErrors", "width", "height", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.treetable.TreeTableState.class, new String[] {"caption", "styles", "enabled", "height", "propertyReadOnly", "id", "immediate", "readOnly", "resources", "errorMessage", "width", "modified", "primaryStyleName", "required", "tabIndex", "registeredEventListeners", "description", "hideErrors", });
            store.setProperties(com.vaadin.shared.ui.embedded.EmbeddedState.class, new String[] {"height", "styles", "errorMessage", "registeredEventListeners", "readOnly", "resources", "alternateText", "width", "primaryStyleName", "enabled", "caption", "id", "description", "immediate", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.PushConfigurationState.class, new String[] {"mode", "parameters", });
            store.setProperties(com.vaadin.shared.ui.label.LabelState.class, new String[] {"immediate", "text", "caption", "registeredEventListeners", "errorMessage", "enabled", "styles", "resources", "readOnly", "description", "id", "primaryStyleName", "width", "contentMode", "height", });
            store.setProperties(com.vaadin.shared.ui.button.NativeButtonState.class, new String[] {"primaryStyleName", "description", "resources", "width", "htmlContentAllowed", "readOnly", "clickShortcutKeyCode", "id", "registeredEventListeners", "styles", "errorMessage", "disableOnClick", "tabIndex", "immediate", "caption", "height", "enabled", "iconAltText", });
            store.setProperties(com.vaadin.shared.ui.video.VideoState.class, new String[] {"width", "id", "caption", "styles", "autoplay", "height", "immediate", "enabled", "registeredEventListeners", "htmlContentAllowed", "muted", "altText", "resources", "sourceTypes", "primaryStyleName", "description", "showControls", "readOnly", "sources", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.AbstractMediaState.class, new String[] {"sources", "showControls", "width", "caption", "autoplay", "readOnly", "resources", "styles", "immediate", "enabled", "id", "registeredEventListeners", "altText", "htmlContentAllowed", "sourceTypes", "height", "errorMessage", "primaryStyleName", "muted", "description", });
            ...
            store.setProperties(com.vaadin.shared.ui.image.ImageState.class, new String[] {"resources", "alternateText", "readOnly", "styles", "errorMessage", "immediate", "primaryStyleName", "id", "enabled", "caption", "width", "registeredEventListeners", "height", "description", });
            store.setProperties(com.vaadin.shared.ui.csslayout.CssLayoutState.class, new String[] {"description", "registeredEventListeners", "resources", "id", "width", "styles", "immediate", "primaryStyleName", "childCss", "enabled", "readOnly", "height", "caption", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.JavaScriptComponentState.class, new String[] {"rpcInterfaces", "styles", "description", "primaryStyleName", "height", "resources", "readOnly", "errorMessage", "caption", "width", "immediate", "id", "registeredEventListeners", "enabled", "callbackNames", });
            store.setProperties(com.vaadin.shared.ui.form.FormState.class, new String[] {"caption", "tabIndex", "enabled", "id", "layout", "footer", "description", "errorMessage", "immediate", "required", "width", "resources", "modified", "primaryStyleName", "height", "readOnly", "registeredEventListeners", "propertyReadOnly", "styles", "hideErrors", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.HorizontalSplitPanelState.class, new String[] {"resources", "readOnly", "registeredEventListeners", "id", "width", "secondChild", "splitterState", "firstChild", "description", "caption", "styles", "enabled", "errorMessage", "primaryStyleName", "height", "immediate", });
            store.setProperties(java.util.Date.class, new String[] {"minutes", "year", "month", "time", "seconds", "hours", "date", });
            store.setProperties(com.vaadin.shared.ui.checkbox.CheckBoxState.class, new String[] {"errorMessage", "width", "checked", "tabIndex", "caption", "id", "enabled", "readOnly", "immediate", "registeredEventListeners", "propertyReadOnly", "resources", "hideErrors", "description", "modified", "styles", "height", "primaryStyleName", "required", });
            store.setProperties(com.vaadin.shared.ui.tree.TreeState.class, new String[] {"modified", "required", "enabled", "primaryStyleName", "tabIndex", "readOnly", "registeredEventListeners", "immediate", "description", "height", "errorMessage", "width", "caption", "resources", "id", "hideErrors", "styles", "propertyReadOnly", });
            store.setProperties(com.vaadin.shared.ui.link.LinkState.class, new String[] {"readOnly", "styles", "caption", "immediate", "errorMessage", "enabled", "id", "description", "width", "resources", "primaryStyleName", "height", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.tabsheet.TabsheetState.class, new String[] {"immediate", "errorMessage", "width", "resources", "styles", "enabled", "id", "primaryStyleName", "caption", "height", "description", "readOnly", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.VerticalSplitPanelState.class, new String[] {"styles", "id", "errorMessage", "splitterState", "secondChild", "description", "height", "readOnly", "primaryStyleName", "width", "registeredEventListeners", "resources", "immediate", "caption", "enabled", "firstChild", });
            store.setProperties(com.vaadin.shared.JavaScriptExtensionState.class, new String[] {"callbackNames", "resources", "rpcInterfaces", "enabled", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.progressindicator.ProgressBarState.class, new String[] {"errorMessage", "styles", "hideErrors", "description", "propertyReadOnly", "indeterminate", "enabled", "width", "registeredEventListeners", "required", "height", "tabIndex", "id", "primaryStyleName", "caption", "resources", "state", "modified", "readOnly", "immediate", });
            store.setProperties(com.vaadin.shared.ui.absolutelayout.AbsoluteLayoutState.class, new String[] {"errorMessage", "registeredEventListeners", "styles", "connectorToCssPosition", "immediate", "enabled", "resources", "primaryStyleName", "readOnly", "description", "height", "caption", "id", "width", });
            store.setProperties(com.vaadin.shared.ui.textfield.AbstractTextFieldState.class, new String[] {"tabIndex", "height", "propertyReadOnly", "modified", "primaryStyleName", "styles", "caption", "width", "readOnly", "hideErrors", "enabled", "errorMessage", "maxLength", "required", "description", "columns", "id", "immediate", "text", "inputPrompt", "registeredEventListeners", "resources", });
            ...
            store.setProperties(com.vaadin.shared.ui.splitpanel.AbstractSplitPanelState.SplitterState.class, new String[] {"locked", "positionReversed", "minPosition", "positionUnit", "maxPosition", "minPositionUnit", "maxPositionUnit", "position", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.class, new String[] {"description", "enabled", "localeServiceState", "tooltipConfiguration", "id", "styles", "pushConfiguration", "height", "pageState", "loadingIndicatorConfiguration", "resources", "primaryStyleName", "immediate", "errorMessage", "tabIndex", "caption", "pollInterval", "overlayContainerLabel", "width", "readOnly", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.LocaleServiceState.class, new String[] {"localeData", });
            store.setProperties(com.vaadin.shared.AbstractComponentState.class, new String[] {"styles", "height", "width", "id", "resources", "errorMessage", "enabled", "caption", "primaryStyleName", "registeredEventListeners", "description", "immediate", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.popupview.PopupViewState.class, new String[] {"styles", "width", "enabled", "resources", "height", "id", "primaryStyleName", "readOnly", "description", "hideOnMouseOut", "errorMessage", "registeredEventListeners", "immediate", "caption", "html", });
            ...
            store.setProperties(com.vaadin.shared.ui.textarea.TextAreaState.class, new String[] {"resources", "height", "immediate", "wordwrap", "modified", "readOnly", "registeredEventListeners", "width", "styles", "maxLength", "propertyReadOnly", "enabled", "rows", "required", "id", "primaryStyleName", "inputPrompt", "errorMessage", "hideErrors", "description", "tabIndex", "text", "caption", "columns", });
            store.setProperties(com.vaadin.shared.ui.browserframe.BrowserFrameState.class, new String[] {"enabled", "width", "readOnly", "styles", "height", "id", "alternateText", "description", "caption", "primaryStyleName", "errorMessage", "resources", "immediate", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.TooltipConfigurationState.class, new String[] {"openDelay", "closeTimeout", "quickOpenDelay", "quickOpenTimeout", "maxWidth", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.calendar.CalendarState.Day.class, new String[] {"localizedDateFormat", "date", "dayOfWeek", "week", });
            store.setProperties(com.vaadin.shared.ui.calendar.CalendarState.Event.class, new String[] {"timeTo", "description", "timeFrom", "styleName", "dateTo", "dateFrom", "index", "allDay", "caption", });
            store.setProperties(com.vaadin.shared.ui.calendar.CalendarState.class, new String[] {"scroll", "actions", "registeredEventListeners", "format24H", "errorMessage", "id", "firstDayOfWeek", "lastVisibleDayOfWeek", "width", "now", "styles", "readOnly", "days", "monthNames", "height", "description", "lastHourOfDay", "enabled", "firstVisibleDayOfWeek", "firstHourOfDay", "caption", "primaryStyleName", "dayNames", "immediate", "resources", "events", });
            store.setProperties(com.vaadin.shared.ui.calendar.CalendarState.Action.class, new String[] {"startDate", "actionKey", "iconKey", "endDate", "caption", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGradientState.class, new String[] {"description", "styles", "resources", "id", "cursorX", "width", "caption", "height", "immediate", "cursorY", "errorMessage", "primaryStyleName", "registeredEventListeners", "enabled", "bgColor", "readOnly", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerState.class, new String[] {"description", "width", "readOnly", "enabled", "htmlContentAllowed", "immediate", "color", "height", "styles", "registeredEventListeners", "resources", "errorMessage", "showDefaultCaption", "primaryStyleName", "popupVisible", "id", "caption", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGridState.class, new String[] {"registeredEventListeners", "immediate", "readOnly", "enabled", "primaryStyleName", "columnCount", "styles", "rowCount", "resources", "changedColor", "description", "changedY", "id", "changedX", "errorMessage", "caption", "width", "height", });
